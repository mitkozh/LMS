...
export const bookValidationMessages: ValidationMessages = {
  ...
  authors: [{ type: 'required', message: 'Authors cannot be empty' }],
  categories: [{ type: 'required', message: 'Categories cannot be empty' }],
  volume: [
  ...
  callNumber: [
    ...
    { type: 'callNumberCheckFailed', message: 'Failed to check if call number exists' },
